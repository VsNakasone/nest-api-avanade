...
//a const abaixo é uma atribuição por desestruturação        
...
if(!checkUser){
    ...
    async update(id: number, req: UpdateUsertDTO): Promise<object>{
//essa variável user são os dados atualizados
       const user = await this.getUserById(id.toString());
       const{name, email, password} = req;
//antes de alterar alguém no banco, é necessário verificar se o email desejado está disponível
